        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.noleggi.forEach(function(n) {
                    ...
                    if ((n.origine || '').toLowerCase() === 'frontend') {
    ...
    $(document).on('click', '.bsn-noleggio-details', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                html += '<div style="margin-bottom:8px;"><strong>Origine richiesta:</strong> ' + (((response.origine || '').toLowerCase() === 'frontend') ? 'Sito pubblico' : 'Gestionale interno') + '</div>';
