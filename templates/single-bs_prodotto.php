...
while ( have_posts() ) :
    ...
    <?php endif; ?>
                        ...
                        <div class="bsn-prodotto-date-box">
                            ...
                            <div class="bsn-date-actions">
                                ...
                                <button type="button" class="bsn-public-btn bsn-public-btn-secondary bsn-public-btn-pending" id="bsn-public-add-to-cart" aria-disabled="true">Aggiungi al preventivo</button>
                            </div>
                        ...
                        <div id="bsn-public-quote-preview" class="bsn-public-quote-box">
                            ...
                            <div class="bsn-price-note">Inserisci date e quantit&agrave; per ottenere una stima pre-carrello con la logica prezzo pubblica standard.</div>
                        </div>
    ...
    (function() {
        ...
        if (!btn || !addBtn || !inputRitiro || !inputRiconsegna || !inputQty || !result || !quoteBox || !cartNote || !feedbackBox) {
            return;
        }
